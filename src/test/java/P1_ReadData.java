...
public class P1_ReadData {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Statement st = con.createStatement();//ouery calıstırmak ıcın
      ...
      /*  ResultSet kayitlar=st.executeQuery("select*from talebeler");
        ...
        ResultSet kayitlarByk90 = st.executeQuery("select * from talebeler where yazili_notu>90");
        while (kayitlarByk90.next()) {
            System.out.printf("%-6d %-15s %-8d\n", kayitlarByk90.getInt(1), kayitlarByk90.getString(2), kayitlarByk90.getInt(4));
        ...
        while (id124.next()) {
            System.out.printf("%-6s %-15s %-8s %-5s\n", id124.getObject(1), id124.getObject(2),
                    id124.getObject(3), id124.getObject(4));
        }
